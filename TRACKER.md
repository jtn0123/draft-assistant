...
| 8 | Backtest harness (t3code) + season-aware sync-badge threshold + calibration note | todo | Harness replays a finished season through the shipped model (Brier, log loss, sigma fit) — the only artifact anywhere that validates the displayed odds. |
