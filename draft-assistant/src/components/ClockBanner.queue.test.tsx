// The pick queue below the banner: whose turn each upcoming pick is, what the
// strip says is still to come, and what it draws once the draft is over.
//
// Split from ClockBanner.test.tsx, which is at the file-size cap. The banner's
// own tests (the clock, the auction notice, the live region) stay there.
